...
const cardBaseUrl = 'https://www.timeloopinteractive.com/cardbots/';
const playArea    = document.getElementById('play-area');
// Add background image to play area
playArea.style.background = "url('https://www.timeloopinteractive.com/cardbots/background.png') no-repeat center center";
playArea.style.backgroundSize = "800px 600px";
...
const SPECIAL_CARD_WIDTH  = 100;
const SPECIAL_CARD_HEIGHT = 70;
...
function renderTable() {
  ...
  tableCards.forEach((e, i) => {
    ...
    // detect special‐deck cards by their folder name
    const isSpecial = e.card.includes('glads/');

    const w = isSpecial ? SPECIAL_CARD_WIDTH : CARD_WIDTH;
    const h = isSpecial ? SPECIAL_CARD_HEIGHT : null;
